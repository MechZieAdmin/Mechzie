        ...
        <div className="bg-card/75 dark:bg-[#121212]/40 backdrop-blur-md border border-border dark:border-white/5 rounded-2xl p-8 md:p-12 space-y-12 shadow-xl">
          <section className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-foreground">1. Contractual Relationship</h2>
            </div>
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-foreground">2. The Services</h2>
            </div>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-foreground">4. Bookings, Payments, and Cancellations</h2>
            </div>
            <p className="text-muted-foreground leading-relaxed">
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              <li><strong className="text-foreground font-semibold">Pricing:</strong> Standard diagnostics and service fees are visible in the app prior to booking. Extra spare parts and additional labor charges will be discussed and approved by you before the mechanic begins repairs.</li>
              <li><strong className="text-foreground font-semibold">Taxes:</strong> All payments facilitated by MechZie are inclusive of applicable taxes unless stated otherwise.</li>
              <li><strong className="text-foreground font-semibold">Cancellation Policy:</strong> A cancellation fee may apply if you cancel a service request after a mechanic has already been dispatched and is en route to your location.</li>
            </ul>
          </section>
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-foreground">5. Limitation of Liability & Disclaimers</h2>
            </div>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-foreground">6. Governing Law & Jurisdiction</h2>
            </div>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="border-t border-border dark:border-white/5 pt-8 space-y-4">
            <h3 className="text-lg font-bold text-foreground">Need Clarifications?</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-muted-foreground bg-muted/50 dark:bg-white/5 p-4 rounded-xl border border-border dark:border-white/5">
              ...
              <div>
                <span className="block font-medium text-foreground mb-1">Support Phone:</span>
                +91 8247767685
              </div>
            </div>
          </div>
