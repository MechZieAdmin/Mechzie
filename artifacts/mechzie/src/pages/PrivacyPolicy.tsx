        ...
        <div className="bg-[#121212]/40 backdrop-blur-md border border-white/5 rounded-2xl p-8 md:p-12 space-y-12 shadow-xl">
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              <li><strong>Account Information:</strong> Name, phone number, email address, and login credentials when you sign up.</li>
              <li><strong>Location Data:</strong> Real-time GPS location (crucial for locating your vehicle and routing the nearest mechanic to your exact location). You can enable or disable location tracking via device settings.</li>
              <li><strong>Vehicle Details:</strong> Vehicle make, model, year, license plate, and fuel type to ensure matching with correct spare parts and mechanics.</li>
              <li><strong>Service Requests:</strong> Photos, text descriptions of breakdown problems, and communication history with the mechanic.</li>
              <li><strong>Payment Details:</strong> Transaction details, payment methods, and billing information processed securely via certified third-party payment gateways.</li>
            </ul>
          </section>
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-white">4. Data Sharing and Security</h2>
            </div>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-white">5. Your Choices & Account Deletion</h2>
            </div>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="border-t border-white/5 pt-8 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-muted-foreground bg-white/5 p-4 rounded-xl border border-white/5">
              <div>
                <span className="block font-medium text-white mb-1">Email Support:</span>
                <a href="mailto:admin@mechzie.in" className="text-primary hover:underline">admin@mechzie.in</a>
              </div>
              <div>
                <span className="block font-medium text-white mb-1">Office Address:</span>
